...
use Acme\FindMartialBundle\Entity\Training;
use Acme\FindMartialBundle\Form\TrainingType;
...
class TrainingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeFindMartialBundle:Training')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeFindMartialBundle:Training:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeFindMartialBundle:Training')->find($id);
     ...
     * @Method("PUT")
     * @Template("AcmeFindMartialBundle:Training:edit.html.twig")
     */
